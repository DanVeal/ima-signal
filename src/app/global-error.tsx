...
export default function GlobalError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <html lang="en" className="h-full antialiased">
      <body className="flex min-h-full flex-col items-center justify-center gap-6 bg-surface px-6 text-center text-ink-900">
        ...
        <div className="space-y-1.5">
          <h1 className="text-xl font-semibold text-ink-900">IMA Signal hit an unexpected error</h1>
