  ...
  return (
    <PageContainer width="wide">
      <div className="space-y-6">
        ...
        <div>
          <h2 className="text-2xl font-semibold tracking-tight text-ink-900 uppercase">{section.name}</h2>
        ...
        <div className="rounded-lg border border-dashed border-border-strong bg-surface-raised px-6 py-8 text-center">
          <p className="text-sm font-medium text-ink-900">Script matrix not yet available</p>
